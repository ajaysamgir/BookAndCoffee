      ...
      <div className="bg-off-white pv4">
        <div className="ph3 mw7 center">
          ...
          <div className="flex-ns mhn2-ns mb3">
            {(entry.getIn(["data", "books"]) || []).map((product, i) => <div className="ph2-ns w-50-ns" key={i}>
          ...
          <div className="tc">
            <a href="#" className="btn raise">See all Books</a>
          </div>
        </div>
      </div>
        ...
        <div className="ph3 mw7 center">
          ...
          <div className="flex-l mhn2-l">
            <div className="w-40-l ph2-l">
              <h2 className="f2 b lh-title mb2">{entry.getIn(["data", "authors", "heading"])}</h2>

              <p>{entry.getIn(["data", "authors", "text"])}</p>
            </div>
